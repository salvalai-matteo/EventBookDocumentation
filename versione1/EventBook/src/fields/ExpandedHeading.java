...
public enum ExpandedHeading{
	...
	DURATA("Durata", "Durata in termini di numero (approssimativo) di ore e minuti, per gli eventi che si esauriscono in un sol giorno, o in termini di numero esatto di giorni, per gli eventi che occupano piÃ¹ giorni	consecutivi", false),
	 ...
	 */
	private ExpandedHeading(String name, String description, boolean binding) {
		this.name = name;
